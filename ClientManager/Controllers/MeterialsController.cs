...
{
    public class MeterialsController : Controller
    {
        ...
        {
            var meterials = db.Materials;
            return View(meterials.ToList());
        }
            ...
            try
            {
                ...
                if (num > 0)
                    data = new JsonReponse()
                    {
                        ...
                        status = "Success",
                        redirectURL = "/Meterials/List"
                    };
                else
                    data = new JsonReponse()
                    {
                        message = "Meterial creation not completed, try again after sometime.",
                        status = "Failed",
                        redirectURL = ""
                    };
            }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            DBOperation.Material expenceCategory = db.Materials.Find(id);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (this.db.SaveChanges() > 0)
                        data = new JsonReponse()
                        {
                            message = "Meterial details saved successfully!",
                            status = "Success",
                            redirectURL = "/Meterials/List"
                        };
                    else
